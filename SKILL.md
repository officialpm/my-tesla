...
python3 {baseDir}/scripts/tesla.py report --one-line   # single-line summary (alias for `summary`)
python3 {baseDir}/scripts/tesla.py report --compact    # core lines only (also makes `--json` output single-line + compact)
python3 {baseDir}/scripts/tesla.py report --json --compact   # small sanitized JSON payload (single-line)
python3 {baseDir}/scripts/tesla.py report --no-wake
python3 {baseDir}/scripts/tesla.py report --no-wake --json --compact   # if asleep/offline: single-line JSON + exit 3
...
python3 {baseDir}/scripts/tesla.py status --no-wake --json --compact   # if asleep/offline: single-line JSON + exit 3
...
python3 {baseDir}/scripts/tesla.py status --json --safe-json --compact     # single-line safe JSON (chat/log friendly)
...
python3 {baseDir}/scripts/tesla.py charge status --json --compact   # single-line JSON (nice for chat/logs)
