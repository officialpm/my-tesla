...
python3 scripts/tesla.py report --one-line   # single-line summary (alias for `summary`)
...
python3 scripts/tesla.py status --json --safe-json --compact     # single-line safe JSON (chat/log friendly)
